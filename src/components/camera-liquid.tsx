...
const emotionCopyMap = {
  id: {
    happy: { emoji: "😊", text: "Terasa ceria, memancarkan aura positif." },
    surprised: { emoji: "😮", text: "Ada energi melonjak, ambil napas sejenak." },
    neutral: { emoji: "🙂", text: "Tenang dan seimbang, siap mengalir." },
    tired: { emoji: "🥱", text: "Lelah yang jujur. Berikan ruang untuk hening." },
    sad: { emoji: "😢", text: "Ada selaput muram, mari kita peluk rasa ini." },
    angry: { emoji: "😡", text: "Energi mendidih. Lepaskan perlahan di sini." },
  },
  en: {
    happy: { emoji: "😊", text: "Radiating joy and positive warmth." },
    surprised: { emoji: "😮", text: "A sudden burst of energy. Breathe with it." },
    neutral: { emoji: "🙂", text: "Grounded and balanced. Ready to flow." },
    tired: { emoji: "🥱", text: "An honest exhaustion. Let yourself rest." },
    sad: { emoji: "😢", text: "A gentle sorrow. It is safe to feel this here." },
    angry: { emoji: "😡", text: "Simmering tension. Exhale it into the mirror." },
  },
} as const;
...
const statusCopyMap: Record<"id" | "en", Record<PermissionState, { label: string; detail: string; color: string }>> = {
  id: {
    idle: {
      label: "Meminta izin cermin",
      detail: "Mirror butuh tatapanmu untuk membaca kedalaman batin.",
      color: "text-white",
    },
    granted: {
      label: "Merasakan getaran emosi",
      detail: "Setiap hela napas dan senyummu sedang dipahami tanpa menghakimi.",
      color: "text-emerald-300",
    },
    denied: {
      label: "Cermin tertutup",
      detail: "Tanpa pandanganmu, Mirror hanya bisa menerka lewat tulisan.",
      color: "text-rose-300",
    },
    paused: {
      label: "Cermin beristirahat",
      detail: "Buka kembali cermin saat kamu siap untuk dilihat.",
      color: "text-white/70",
    },
  },
  en: {
    idle: {
      label: "Awaiting your gaze",
      detail: "Mirror needs your eyes to understand your inner depth.",
      color: "text-white",
    },
    granted: {
      label: "Sensing your essence",
      detail: "Every breath and micro-expression is understood without judgment.",
      color: "text-emerald-300",
    },
    denied: {
      label: "Mirror veiled",
      detail: "Out of sight, Mirror can only feel your words.",
      color: "text-rose-300",
    },
    paused: {
      label: "Mirror resting",
      detail: "Unveil the glass whenever you are ready to be seen.",
      color: "text-white/70",
    },
  },
};
...
const uiCopyMap = {
  id: {
    ...
    overlayHint: "Biarkan cermin mengenali wujudmu agar obrolan terasa lebih intim.",
    permissionDeniedTitle: "Mirror terhalang",
    permissionDeniedHint: "Izinkan browser menatap matamu, lalu segarkan halaman ini.",
    permissionCallTitle: "Menyelaraskan jiwa",
    permissionCallHint: "Tarik napas dalam. Mirror sedang membiasakan diri dengan cahayamu.",
    statusHeading: "Jejak",
    humanReady: "Koneksi terjalin",
    humanLoading: "Menyelami batin...",
    humanError: "Titik buta",
    humanIdle: "Menunggu hadirmu",
    moodHeading: "Warna Dominan",
    waitingCamera: "Menanti wajahmu",
    brightnessHeading: "Nuansa Cahaya",
    brightnessEmpty: "Masih merekam jejak cahaya di ruanganmu.",
    brightnessAverage: "Kehangatan cahaya ~{value}",
    freezeHeading: "Jeda Sejenak",
    freezeButton: "Abadikan esensi",
    freezeCountdown: "Merekam dalam {count}",
    tipsHeading: "Pengingat Lembut",
    tipsBody:
      "Setiap senyum dan tarikan dahi memiliki ceritanya sendiri. Biarkan Mirror mendengarkan semuanya tanpa jeda.",
    valenceHeading: "Energi & Nuansa",
    valencePositive: "Penuh harapan",
    valenceNegative: "Merenung dalam",
    valenceNeutral: "Tenang",
    energyHigh: "Berapi-api",
    energyLow: "Lembut mengalir",
    focusHeading: "Fokus & Beban",
    focusHigh: "Hadir sepenuhnya",
    focusLow: "Butuh ruang rileks",
    tensionHigh: "Ada beban tertahan",
    tensionLow: "Mengalir rileks",
    tiltLabel: "Gestur",
    tiltStable: "tenang berlabuh",
    cuesEmpty: "Wajahmu hening bercerita.",
    cueSmile: "Ada kehangatan di senyummu.",
    cueTension: "Alismu menyimpan beban, bernapaslah.",
    cueFocus: "Matamu lelah, istirahat sejenak.",
    cueTilt: "Posturmu mencari keseimbangan.",
  },
  en: {
    ...
    overlayHint: "Let the mirror recognize your form to deepen the intimacy of your chat.",
    permissionDeniedTitle: "Mirror is blinded",
    permissionDeniedHint: "Allow your browser to hold your gaze, then refresh this page.",
    permissionCallTitle: "Aligning souls",
    permissionCallHint: "Take a deep breath. Mirror is attuning to your light.",
    statusHeading: "Traces",
    humanReady: "Connection forged",
    humanLoading: "Diving inward...",
    humanError: "Blind spot",
    humanIdle: "Awaiting your presence",
    moodHeading: "Dominant Hues",
    waitingCamera: "Waiting for your face",
    brightnessHeading: "Tones of Light",
    brightnessEmpty: "Still painting the light of your room.",
    brightnessAverage: "Light warmth ~{value}",
    freezeHeading: "A Brief Pause",
    freezeButton: "Capture essence",
    freezeCountdown: "Capturing in {count}",
    tipsHeading: "Gentle Reminder",
    tipsBody:
      "Every smile and furrowed brow has a story. Let Mirror listen to them all continuously.",
    valenceHeading: "Energy & Tone",
    valencePositive: "Hopeful spirit",
    valenceNegative: "Deeply reflective",
    valenceNeutral: "Still",
    energyHigh: "Fiery resonance",
    energyLow: "Gentle flow",
    focusHeading: "Focus & Burden",
    focusHigh: "Fully present",
    focusLow: "Needs space to rest",
    tensionHigh: "Holding onto tension",
    tensionLow: "Flowing gracefully",
    tiltLabel: "Gesture",
    tiltStable: "calmly anchored",
    cuesEmpty: "Your face speaks in silence.",
    cueSmile: "A warm trace of a smile.",
    cueTension: "Your brows hold weight, let it go.",
    cueFocus: "Your eyes are weary, take a pause.",
    cueTilt: "Your posture seeks equilibrium.",
  },
} as const;

type UiCopy = (typeof uiCopyMap)["id"];
type EmotionCopy = (typeof emotionCopyMap)["id"];
...
export function CameraLiquidWidget({
  ...
  const emotionCopy = emotionCopyMap[lang] as EmotionCopy;
  const statusCopy = statusCopyMap[lang];
  const uiCopy = uiCopyMap[lang] as UiCopy;
  const videoRef = useRef<HTMLVideoElement | null>(null);
  const canvasRef = useRef<HTMLCanvasElement | null>(null);
  const streamRef = useRef<MediaStream | null>(null);
  const [permission, setPermission] = useState<PermissionState>("idle");
  const [mood, setMood] = useState<MoodInfo>(uiCopy.defaultMood);
    ...
    const interval = setInterval(async () => {
      ...
      if (meshDetector) {
        try {
          ...
          if (faces.length > 0 && faces[0].keypoints) {
            computedMetrics = analyzeLandmarks(faces[0].keypoints as Landmark[], uiCopy);
          }
        } catch (error) {
      ...
      if (human) {
        try {
          ...
          if (humanFace) {
            const result = applyHumanInsights(humanFace, computedMetrics, emotionCopy, uiCopy);
  ...
  return (
    <div className={`liquid-card ${padding} space-y-5`}>
      <div className="flex flex-col gap-2">
        <p className="emoji-heading">{uiCopy.heading}</p>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          >
            {isCameraOn ? uiCopy.toggleOff : uiCopy.toggleOn}
          </button>
        </div>
      </div>
        ...
        {permission === "granted" ? (
          <>
            ...
            <div className="pointer-events-none absolute left-6 top-6 flex flex-col text-xs text-white/80">
              <span className="text-sm font-semibold text-white">{uiCopy.overlayHeading}</span>
          ...
          <div className="flex h-full flex-col items-center justify-center gap-3 px-8 text-center">
            ...
            <p className="text-lg font-semibold text-white">
              {permission === "denied" ? uiCopy.permissionDeniedTitle : uiCopy.permissionCallTitle}
            </p>
            <p className="text-sm text-white/70">
              {permission === "denied"
                ? uiCopy.permissionDeniedHint
                : uiCopy.permissionCallHint}
            </p>
          </div>
        )}
      </div>
...
function analyzeLandmarks(points: Landmark[], uiCopy: UiCopy): SensorMetrics {
  ...
  const cues: string[] = [];
  if (smileScore > 0.55) cues.push(uiCopy.cueSmile);
  if (tension > 0.65) cues.push(uiCopy.cueTension);
  if (focus < 0.3) cues.push(uiCopy.cueFocus);
  if (tilt && Math.abs(tilt) > 8) cues.push(uiCopy.cueTilt);
...
function applyHumanInsights(
  ...
  if (attention !== null) {
    ...
    if (attention > 0.75) cues.push(uiCopy.cueTension);
  }
  if (headPose?.pitch && headPose.pitch < -5) cues.push(uiCopy.cueTilt);
  if (headPose?.pitch && headPose.pitch > 5) cues.push(uiCopy.cueTilt);
  if (expressions[0]?.label === "disgust") cues.push(uiCopy.cueTension);
...
function mapExpressionToMoodKey(label: string): keyof EmotionCopy | null {
  const normalized = label.toLowerCase();
  const mapping: Record<string, keyof EmotionCopy> = {
    happy: "happy",
    joy: "happy",
    neutral: "neutral",
    sad: "sad",
