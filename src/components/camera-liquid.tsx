...
const emotionCopyMap = {
  ...
  en: {
    ...
    sad: { emoji: "😢", text: "Lead with extra empathy at the start." },
    angry: { emoji: "😡", text: "Use a calming tone plus a short CBT prompt." },
  },
} as const;
...
const statusCopyMap: Record<"id" | "en", Record<PermissionState, { label: string; detail: string; color: string }>> = {
  ...
  en: {
    ...
    granted: {
      ...
      detail: "TensorFlow Lite detects bounding boxes then buckets emotions.",
      color: "text-emerald-300",
    },
    denied: {
      label: "Permission denied",
      detail: "Without the camera, Mirror relies on text mood. Refresh and allow access for the full demo.",
      color: "text-rose-300",
    },
    paused: {
      label: "Camera paused",
...
const uiCopyMap = {
  id: {
    defaultMood: { label: "Memulai ritual", emoji: "👀", description: "Kamera siap membaca ekspresi", confidence: 0 },
    heading: "Mirror Cam",
    subheading: "Kolom kamera + computer vision",
    badge: "Realtime CV demo",
    description:
    ...
    overlayHeading: "Mirror Vision",
    overlayHint: "Sambungkan kamera ke profil onboarding supaya chat otomatis menyesuaikan persona.",
    permissionDeniedTitle: "Mirror butuh izin kamera",
    permissionDeniedHint: "Aktifkan kamera lewat ikon di browser, lalu refresh halaman untuk menyalakan scanner.",
    permissionCallTitle: "Memanggil cermin digital",
    permissionCallHint: "Tahan satu detik. Mirror sedang menyelaraskan cahaya & fokus sebelum menampilkan feed.",
    statusHeading: "Status",
    humanReady: "Human AI aktif",
    humanLoading: "Memuat engine Human...",
    humanError: "Eksperimental off",
    humanIdle: "Menunggu aktivasi",
    moodHeading: "Mood bucket",
    ...
    freezeButton: "Ambil snapshot",
    freezeCountdown: "Menangkap dalam {count}",
    ...
    valenceHeading: "Valence & energy",
    valencePositive: "Nada optimis",
    valenceNegative: "Nada mellow",
    ...
    cueSmile: "Senyum hangat terdeteksi.",
    cueTension: "Alis menegang, bantu relaksasi.",
    cueFocus: "Kelopak mata berat, tawarkan jeda.",
    cueTilt: "Kepala miring, ajak stabilisasi postur.",
  },
  en: {
    defaultMood: { label: "Starting ritual", emoji: "👀", description: "Camera ready to read expressions", confidence: 0 },
    heading: "Mirror Cam",
    subheading: "Camera + computer vision",
    badge: "Realtime CV demo",
    description:
      "The camera is enlarged so testers feel like they're facing a mirror. Mirror only reads micro-expressions & light—no photos are stored. Mention this during demos so testers feel safe. ✨",
    toggleOn: "Turn on camera",
    toggleOff: "Turn off camera",
    overlayHeading: "Mirror Vision",
    overlayHint: "Link the camera to an onboarding profile so chat adapts automatically.",
    permissionDeniedTitle: "Mirror needs camera permission",
    permissionDeniedHint: "Enable the camera in your browser and refresh to start the scanner.",
    permissionCallTitle: "Calling the digital mirror",
    permissionCallHint: "Hold on a second. Mirror is syncing light & focus before showing the feed.",
    statusHeading: "Status",
    humanReady: "Human AI active",
    humanLoading: "Loading Human engine...",
    humanError: "Experimental off",
    humanIdle: "Waiting to activate",
    moodHeading: "Mood bucket",
    ...
    freezeHeading: "Freeze frame",
    freezeButton: "Take snapshot",
    freezeCountdown: "Capturing in {count}",
    tipsHeading: "Demo tips",
    tipsBody:
      "Use the brightness graph to explain expression shifts. You can show snapshots to the research team without saving them.",
    valenceHeading: "Valence & energy",
    valencePositive: "Optimistic tone",
    valenceNegative: "Mellow tone",
    ...
    tensionHigh: "Brows tensing",
    tensionLow: "Jaw fairly relaxed",
    tiltLabel: "Head tilt",
    tiltStable: "steady",
    cuesEmpty: "No camera cues yet.",
    cueSmile: "Warm smile detected.",
    cueTension: "Brows tense, help them relax.",
    cueFocus: "Droopy eyelids, offer a pause.",
    cueTilt: "Head tilted, invite posture reset.",
  },
} as const;
